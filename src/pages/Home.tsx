    ...
    <div>
      ...
      <section className="footter">
        <div className="container">
            ...
            <div className="col-6 col-md-4 col-lg-2">
              ...
              <ul>
                ...
                <li>
                  <a href="#">
                    ClearVoice
                    <p className="fix-m">Content Marketing</p>
                  </a>
                </li>
                <li>
                  <a href="#">
                    Fiverr Workspace
                    <p className="fix-m">Invoice Software</p>
                  </a>
                </li>
                <li>
                  <a href="#">
                    Learn
                    <p className="fix-m">Online Courses</p>
                  </a>
                </li>
                <li>
          ...
          <hr />
          <div className="row d-flex justify-content-between align-items-center mb-4 mt-5">
            <div className="row col-lg-6 col-md-6 col-sm-12">
              ...
              <div className="col-lg-9 col-md-8 col-sm-8 text-center">
            ...
            <div className="row col-lg-6 col-md-6 col-sm-12">
              <div className="col-lg-6 col-md-8 col-sm-6">
                <ul className="social d-flex justify-content-around">
                  <li>
              ...
              <div className="col-lg-6 col-md-4 col-sm-6 text-center">
                <div className="settings-buttons">
                  <section className="d-flex justify-content-around align-items-center">
                    <button className="d-flex global-btn">
                      <span>
                        <svg
                          width="18"
                          height="18"
                      ...
                      <span className="e-label">English</span>
                    </button>
                    <button className="dola-btn">
                      <span className="dola">US$ USD</span>
                    </button>
